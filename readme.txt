...
2 Feature
	[1] Supports multi payment accounts for single one payment method.
	[2] Can be easily extended to support new payment method
	[3] Automatically refund the duplicated charge amounts.
	[4] Automatically download check-bill for every single day.