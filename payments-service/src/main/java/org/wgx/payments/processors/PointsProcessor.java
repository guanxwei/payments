...
/**
 * Payment processor to support purchasing by points.
 * @author hzweiguanxiong
 *
 */
public class PointsProcessor extends SimplePaymentProcessor {

    private static final String NAME = PaymentMethod.POINTS.name();
